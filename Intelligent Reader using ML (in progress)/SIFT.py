...
Name = ['quad','quad1','double','double1']  #change the folders here to learn the different note
...
for num,i in enumerate(DB_processed):
    List = []
    for j in range(len(DB_processed[i])):
        List.append(siftlearn(DB_processed[i][j]))
    DB_feature[i]=List
  
List = Test(Test_processed,DB_processed)          
